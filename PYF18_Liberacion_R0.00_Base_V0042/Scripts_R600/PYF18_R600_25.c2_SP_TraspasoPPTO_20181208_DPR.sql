...
-- //////////////////////////////////////////////////////////////////////////
-- // STORED PROCEDURE --->  UP TRASPASO UPDATE
-- //////////////////////////////////////////////////////////////////////////
...
--	@PP_K_ESTATUS_TRASPASO			INT,
	...
	@PP_C_TRASPASO					VARCHAR(255),
	@PP_MONTO_APLICAR				DECIMAL(19,4),
	@PP_F_OPERACION					DATE				-- FECHA NUEVA TRASPASO
AS			
	...
	DECLARE @VP_F_OPERACION				DATE			-- FECHA PREVIA TRASPASO
	DECLARE @VP_K_RUBRO_PRESUPUESTO		INT = 0 
	DECLARE @VP_K_UNIDAD_OPERATIVA		INT = 0
		
	SELECT	@VP_F_OPERACION	=			F_OPERACION,
			@VP_K_RUBRO_PRESUPUESTO =	K_RUBRO_PRESUPUESTO,
	...
	IF @VP_MENSAJE='' -- VALIDACIÓN POR FECHA PREVIA
		EXECUTE [dbo].[PG_RN_TRASPASO_UPDATE]		@PP_L_DEBUG, @PP_K_SISTEMA_EXE, @PP_K_USUARIO_ACCION,
													@PP_K_TRASPASO, @VP_K_UNIDAD_OPERATIVA, @VP_F_OPERACION,
													@OU_RESULTADO_VALIDACION = @VP_MENSAJE		OUTPUT

	-- ///////////////////////////////////////////////////////////////////// 	
	
	IF @VP_MENSAJE='' -- VALIDACIÓN POR FECHA NUEVA
		EXECUTE [dbo].[PG_RN_TRASPASO_UPDATE]		@PP_L_DEBUG, @PP_K_SISTEMA_EXE, @PP_K_USUARIO_ACCION,
													@PP_K_TRASPASO, @PP_K_UNIDAD_OPERATIVA, @PP_F_OPERACION,
													@OU_RESULTADO_VALIDACION = @VP_MENSAJE		OUTPUT
	...
	IF @VP_MENSAJE=''
		...
		DECLARE @VP_K_YYYY_PREVIO			INT = 0
		DECLARE @VP_K_MM_PREVIO				INT = 0

		SET	@VP_K_YYYY_PREVIO =			YEAR(@VP_F_OPERACION) 
		SET	@VP_K_MM_PREVIO =			MONTH(@VP_F_OPERACION) 

		-- ============================================

		DECLARE @VP_K_PRESUPUESTO_PREVIO	INT 

		EXECUTE [dbo].[PG_RN_PRESUPUESTO_K_X_PARAMETROS]	@PP_L_DEBUG, @PP_K_SISTEMA_EXE, @PP_K_USUARIO_ACCION,
															@VP_K_UNIDAD_OPERATIVA,	@VP_K_YYYY_PREVIO,	@VP_K_MM_PREVIO,
															@OU_K_PRESUPUESTO=	@VP_K_PRESUPUESTO_PREVIO	OUTPUT
		
		IF @VP_K_PRESUPUESTO_PREVIO IS NULL
			SET @VP_K_PRESUPUESTO_PREVIO = 0

		-- ============================================
		
		IF @VP_K_PRESUPUESTO_PREVIO <> 0 -- VALIDACIÓN DE PRESUPUESTO POR FECHA PREVIA
			EXECUTE [dbo].[PG_RN_PARTIDA_PRESUPUESTO_UPDATE]		@PP_L_DEBUG, @PP_K_SISTEMA_EXE, @PP_K_USUARIO_ACCION,
																	@VP_K_PRESUPUESTO_PREVIO, @VP_K_RUBRO_PRESUPUESTO,
																	@OU_RESULTADO_VALIDACION= @VP_MENSAJE	OUTPUT	
		ELSE
			SET @VP_MENSAJE = 'No se encontró el <Presupuesto> para la Fecha Previa'

		END

	-- /////////////////////////////////////////////////////////////////////

	DECLARE @VP_K_YYYY_NUEVO			INT = 0
	DECLARE @VP_K_MM_NUEVO				INT = 0
	DECLARE	@VP_K_PRESUPUESTO_NUEVO		INT = 0

	IF @VP_MENSAJE=''
		BEGIN

		SET @VP_K_YYYY_NUEVO =		YEAR(@PP_F_OPERACION)
		SET @VP_K_MM_NUEVO =		MONTH(@PP_F_OPERACION)

		-- ============================================

		EXECUTE [dbo].[PG_RN_PRESUPUESTO_K_X_PARAMETROS]	@PP_L_DEBUG, @PP_K_SISTEMA_EXE, @PP_K_USUARIO_ACCION,
															@PP_K_UNIDAD_OPERATIVA,	@VP_K_YYYY_NUEVO,	@VP_K_MM_NUEVO,
															@OU_K_PRESUPUESTO =	@VP_K_PRESUPUESTO_NUEVO		OUTPUT

		IF @VP_K_PRESUPUESTO_NUEVO IS NULL
			SET @VP_K_PRESUPUESTO_NUEVO = 0

		-- ============================================
		
		IF @VP_K_PRESUPUESTO_NUEVO <> 0 -- VALIDACIÓN DE PRESUPUESTO POR FECHA NUEVA
			EXECUTE [dbo].[PG_RN_PARTIDA_PRESUPUESTO_UPDATE]		@PP_L_DEBUG, @PP_K_SISTEMA_EXE, @PP_K_USUARIO_ACCION,
																	@VP_K_PRESUPUESTO_NUEVO, @PP_K_RUBRO_PRESUPUESTO,
																	@OU_RESULTADO_VALIDACION= @VP_MENSAJE	OUTPUT	
		ELSE
			SET @VP_MENSAJE = 'No se encontró el <Presupuesto> para la Fecha Nueva'
	...
	IF @VP_MENSAJE=''
		...
		IF @PP_K_TIPO_TRASPASO=1
			EXECUTE [dbo].[PG_RN_PRESUPUESTO_DISPONIBLE]	@PP_L_DEBUG, @PP_K_SISTEMA_EXE, @PP_K_USUARIO_ACCION,
															0, @VP_K_PRESUPUESTO_NUEVO, @PP_K_RUBRO_PRESUPUESTO, @PP_K_TRASPASO,
															@PP_K_UNIDAD_OPERATIVA,	@VP_K_YYYY_NUEVO, @VP_K_MM_NUEVO, @PP_MONTO_APLICAR,
															@OU_RESULTADO_VALIDACION = @VP_MENSAJE		OUTPUT
		END
	...
	IF @VP_MENSAJE=''
		...
		--	@PP_K_UNIDAD_OPERATIVA,	@PP_F_OPERACION, @PP_K_RUBRO_PRESUPUEST
		IF @PP_K_TIPO_TRASPASO<>1
			EXECUTE [DBO].[PG_AU_TRASPASO_INIT]		@PP_L_DEBUG,@PP_K_SISTEMA_EXE,@PP_K_USUARIO_ACCION,
													@PP_K_TRASPASO		

		-- ACTUALIZACIÓN DE ESCENARIO ANTERIOR
		EXECUTE	[DBO].[PG_UP_PARTIDA_PRESUPUESTO_CALCULO_EJERCICIO]		@PP_L_DEBUG, @PP_K_SISTEMA_EXE, @PP_K_USUARIO_ACCION,
																		@VP_K_UNIDAD_OPERATIVA,@VP_F_OPERACION, @VP_K_RUBRO_PRESUPUESTO

		-- ACTUALIZACIÓN FORMA ACTUAL DE TRASPASO
		EXECUTE	[DBO].[PG_UP_PARTIDA_PRESUPUESTO_CALCULO_EJERCICIO]		@PP_L_DEBUG, @PP_K_SISTEMA_EXE, @PP_K_USUARIO_ACCION,
																		@PP_K_UNIDAD_OPERATIVA,	@PP_F_OPERACION, @PP_K_RUBRO_PRESUPUESTO
