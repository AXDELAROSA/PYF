...
-- // Fecha modificación:	10/DIC/2018
-- ////////////////////////////////////////////////////////////// 
...
-- //////////////////////////////////////////////////////////////
-- // STORED PROCEDURE ---> PLAN_GASTO_GENERAR_X_K_PLAN_PRESUPUESTO
-- //////////////////////////////////////////////////////////////
...
AS		
	...
	IF @VP_K_TEMPORADA=1
		...
		SET		K_PROGRAMACION_PARTIDA	=	PPP.K_PROGRAMACION_PARTIDA,
				M04_MONTO_ESTIMADO		=	PPP.M01_AUTORIZADO,
	...
	ELSE
		IF @VP_K_TEMPORADA=2
			UPDATE	PARTIDA_PLAN_GASTO 
			SET		K_PROGRAMACION_PARTIDA	=	PPP.K_PROGRAMACION_PARTIDA,
					M10_MONTO_ESTIMADO		=	PPP.M01_AUTORIZADO,
	...
	IF @VP_K_TEMPORADA=2
		...
		UPDATE	PARTIDA_PLAN_GASTO 
		SET		K_PROGRAMACION_PARTIDA	=	PPP.K_PROGRAMACION_PARTIDA,
				M01_MONTO_ESTIMADO		=	PPP.M04_AUTORIZADO,
	...
	DECLARE @VP_MONTO_ESTIMADO AS DECIMAL(19,4)=0
	
	
	UPDATE	PARTIDA_PLAN_GASTO
	SET		M00_MONTO_ESTIMADO = (		M01_MONTO_ESTIMADO + M02_MONTO_ESTIMADO
								+	M03_MONTO_ESTIMADO + M04_MONTO_ESTIMADO
								+	M05_MONTO_ESTIMADO + M06_MONTO_ESTIMADO 
								+	M07_MONTO_ESTIMADO + M08_MONTO_ESTIMADO
								+	M09_MONTO_ESTIMADO + M10_MONTO_ESTIMADO 
								+	M11_MONTO_ESTIMADO + M12_MONTO_ESTIMADO	) 
	WHERE	K_PLAN_GASTO=@VP_K_PLAN_GASTO	
