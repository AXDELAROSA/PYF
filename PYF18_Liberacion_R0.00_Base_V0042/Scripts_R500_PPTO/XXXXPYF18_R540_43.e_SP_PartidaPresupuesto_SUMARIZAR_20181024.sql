...
AS
	...
	UPDATE	PARTIDA_PRESUPUESTO
	SET		MES_MONTO_ESTIMADO = (		SELECT	SUM(Q2PAR.MES_MONTO_ESTIMADO) AS SUM_MES_MONTO_ESTIMADO 
										FROM	PARTIDA_PRESUPUESTO AS Q2PAR, RUBRO_PRESUPUESTO AS Q2RUB
			...
			W01_MONTO_ESTIMADO = (		SELECT	SUM(Q2PAR.W01_MONTO_ESTIMADO) AS SUM_MES_MONTO_ESTIMADO 
										FROM	PARTIDA_PRESUPUESTO AS Q2PAR, RUBRO_PRESUPUESTO AS Q2RUB
										WHERE	Q2PAR.K_RUBRO_PRESUPUESTO=Q2RUB.K_RUBRO_PRESUPUESTO
										AND		Q2RUB.K_RUBRO_PADRE=Q1PAR.K_RUBRO_PRESUPUESTO
										AND		Q2PAR.K_PRESUPUESTO=Q1PAR.K_PRESUPUESTO		),
			W02_MONTO_ESTIMADO = (		SELECT	SUM(Q2PAR.W02_MONTO_ESTIMADO) AS SUM_MES_MONTO_ESTIMADO 
										FROM	PARTIDA_PRESUPUESTO AS Q2PAR, RUBRO_PRESUPUESTO AS Q2RUB
										WHERE	Q2PAR.K_RUBRO_PRESUPUESTO=Q2RUB.K_RUBRO_PRESUPUESTO
										AND		Q2RUB.K_RUBRO_PADRE=Q1PAR.K_RUBRO_PRESUPUESTO
										AND		Q2PAR.K_PRESUPUESTO=Q1PAR.K_PRESUPUESTO		),
			W03_MONTO_ESTIMADO = (		SELECT	SUM(Q2PAR.W03_MONTO_ESTIMADO) AS SUM_MES_MONTO_ESTIMADO 
										FROM	PARTIDA_PRESUPUESTO AS Q2PAR, RUBRO_PRESUPUESTO AS Q2RUB
										WHERE	Q2PAR.K_RUBRO_PRESUPUESTO=Q2RUB.K_RUBRO_PRESUPUESTO
										AND		Q2RUB.K_RUBRO_PADRE=Q1PAR.K_RUBRO_PRESUPUESTO
										AND		Q2PAR.K_PRESUPUESTO=Q1PAR.K_PRESUPUESTO		),
			W04_MONTO_ESTIMADO = (		SELECT	SUM(Q2PAR.W04_MONTO_ESTIMADO) AS SUM_MES_MONTO_ESTIMADO 
										FROM	PARTIDA_PRESUPUESTO AS Q2PAR, RUBRO_PRESUPUESTO AS Q2RUB
										WHERE	Q2PAR.K_RUBRO_PRESUPUESTO=Q2RUB.K_RUBRO_PRESUPUESTO
										AND		Q2RUB.K_RUBRO_PADRE=Q1PAR.K_RUBRO_PRESUPUESTO
										AND		Q2PAR.K_PRESUPUESTO=Q1PAR.K_PRESUPUESTO		),
			W05_MONTO_ESTIMADO = (		SELECT	SUM(Q2PAR.W05_MONTO_ESTIMADO) AS SUM_MES_MONTO_ESTIMADO 
										FROM	PARTIDA_PRESUPUESTO AS Q2PAR, RUBRO_PRESUPUESTO AS Q2RUB
										WHERE	Q2PAR.K_RUBRO_PRESUPUESTO=Q2RUB.K_RUBRO_PRESUPUESTO
										AND		Q2RUB.K_RUBRO_PADRE=Q1PAR.K_RUBRO_PRESUPUESTO
										AND		Q2PAR.K_PRESUPUESTO=Q1PAR.K_PRESUPUESTO		)
	FROM	PARTIDA_PRESUPUESTO AS Q1PAR, RUBRO_PRESUPUESTO AS Q2RUB
	WHERE	Q1PAR.K_PRESUPUESTO=@PP_K_PRESUPUESTO
...
AS
	...
	UPDATE	PARTIDA_PRESUPUESTO
	SET		MES_MONTO_EJERCIDO = (		SELECT	SUM(Q2PAR.MES_MONTO_EJERCIDO) AS SUM_MES_MONTO_EJERCIDO 
										FROM	PARTIDA_PRESUPUESTO AS Q2PAR, RUBRO_PRESUPUESTO AS Q2RUB
										WHERE	Q2PAR.K_RUBRO_PRESUPUESTO=Q2RUB.K_RUBRO_PRESUPUESTO
										AND		Q2RUB.K_RUBRO_PADRE=Q1PAR.K_RUBRO_PRESUPUESTO
										AND		Q2PAR.K_PRESUPUESTO=Q1PAR.K_PRESUPUESTO		),
			W01_MONTO_EJERCIDO = (		SELECT	SUM(Q2PAR.W01_MONTO_EJERCIDO) AS SUM_MES_MONTO_EJERCIDO 
										FROM	PARTIDA_PRESUPUESTO AS Q2PAR, RUBRO_PRESUPUESTO AS Q2RUB
										WHERE	Q2PAR.K_RUBRO_PRESUPUESTO=Q2RUB.K_RUBRO_PRESUPUESTO
										AND		Q2RUB.K_RUBRO_PADRE=Q1PAR.K_RUBRO_PRESUPUESTO
										AND		Q2PAR.K_PRESUPUESTO=Q1PAR.K_PRESUPUESTO		),
			W02_MONTO_EJERCIDO = (		SELECT	SUM(Q2PAR.W02_MONTO_EJERCIDO) AS SUM_MES_MONTO_EJERCIDO 
										FROM	PARTIDA_PRESUPUESTO AS Q2PAR, RUBRO_PRESUPUESTO AS Q2RUB
										WHERE	Q2PAR.K_RUBRO_PRESUPUESTO=Q2RUB.K_RUBRO_PRESUPUESTO
										AND		Q2RUB.K_RUBRO_PADRE=Q1PAR.K_RUBRO_PRESUPUESTO
										AND		Q2PAR.K_PRESUPUESTO=Q1PAR.K_PRESUPUESTO		),
			W03_MONTO_EJERCIDO = (		SELECT	SUM(Q2PAR.W03_MONTO_EJERCIDO) AS SUM_MES_MONTO_EJERCIDO 
										FROM	PARTIDA_PRESUPUESTO AS Q2PAR, RUBRO_PRESUPUESTO AS Q2RUB
										WHERE	Q2PAR.K_RUBRO_PRESUPUESTO=Q2RUB.K_RUBRO_PRESUPUESTO
										AND		Q2RUB.K_RUBRO_PADRE=Q1PAR.K_RUBRO_PRESUPUESTO
										AND		Q2PAR.K_PRESUPUESTO=Q1PAR.K_PRESUPUESTO		),
			W04_MONTO_EJERCIDO = (		SELECT	SUM(Q2PAR.W04_MONTO_EJERCIDO) AS SUM_MES_MONTO_EJERCIDO 
										FROM	PARTIDA_PRESUPUESTO AS Q2PAR, RUBRO_PRESUPUESTO AS Q2RUB
										WHERE	Q2PAR.K_RUBRO_PRESUPUESTO=Q2RUB.K_RUBRO_PRESUPUESTO
										AND		Q2RUB.K_RUBRO_PADRE=Q1PAR.K_RUBRO_PRESUPUESTO
										AND		Q2PAR.K_PRESUPUESTO=Q1PAR.K_PRESUPUESTO		),
			W05_MONTO_EJERCIDO = (		SELECT	SUM(Q2PAR.W05_MONTO_EJERCIDO) AS SUM_MES_MONTO_EJERCIDO 
										FROM	PARTIDA_PRESUPUESTO AS Q2PAR, RUBRO_PRESUPUESTO AS Q2RUB
										WHERE	Q2PAR.K_RUBRO_PRESUPUESTO=Q2RUB.K_RUBRO_PRESUPUESTO
										AND		Q2RUB.K_RUBRO_PADRE=Q1PAR.K_RUBRO_PRESUPUESTO
										AND		Q2PAR.K_PRESUPUESTO=Q1PAR.K_PRESUPUESTO		)
...
AS
	...
	UPDATE	PARTIDA_PRESUPUESTO
	SET		MES_MONTO_EN_PROCESO = (	SELECT	SUM(Q2PAR.MES_MONTO_EN_PROCESO) AS SUM_MES_MONTO_EN_PROCESO 
										FROM	PARTIDA_PRESUPUESTO AS Q2PAR, RUBRO_PRESUPUESTO AS Q2RUB
										WHERE	Q2PAR.K_RUBRO_PRESUPUESTO=Q2RUB.K_RUBRO_PRESUPUESTO
										AND		Q2RUB.K_RUBRO_PADRE=Q1PAR.K_RUBRO_PRESUPUESTO
										AND		Q2PAR.K_PRESUPUESTO=Q1PAR.K_PRESUPUESTO		),
			W01_MONTO_EN_PROCESO = (	SELECT	SUM(Q2PAR.W01_MONTO_EN_PROCESO) AS SUM_MES_MONTO_EN_PROCESO 
										FROM	PARTIDA_PRESUPUESTO AS Q2PAR, RUBRO_PRESUPUESTO AS Q2RUB
										WHERE	Q2PAR.K_RUBRO_PRESUPUESTO=Q2RUB.K_RUBRO_PRESUPUESTO
										AND		Q2RUB.K_RUBRO_PADRE=Q1PAR.K_RUBRO_PRESUPUESTO
										AND		Q2PAR.K_PRESUPUESTO=Q1PAR.K_PRESUPUESTO		),
			W02_MONTO_EN_PROCESO = (	SELECT	SUM(Q2PAR.W02_MONTO_EN_PROCESO) AS SUM_MES_MONTO_EN_PROCESO 
										FROM	PARTIDA_PRESUPUESTO AS Q2PAR, RUBRO_PRESUPUESTO AS Q2RUB
										WHERE	Q2PAR.K_RUBRO_PRESUPUESTO=Q2RUB.K_RUBRO_PRESUPUESTO
										AND		Q2RUB.K_RUBRO_PADRE=Q1PAR.K_RUBRO_PRESUPUESTO
										AND		Q2PAR.K_PRESUPUESTO=Q1PAR.K_PRESUPUESTO		),
			W03_MONTO_EN_PROCESO = (	SELECT	SUM(Q2PAR.W03_MONTO_EN_PROCESO) AS SUM_MES_MONTO_EN_PROCESO 
										FROM	PARTIDA_PRESUPUESTO AS Q2PAR, RUBRO_PRESUPUESTO AS Q2RUB
										WHERE	Q2PAR.K_RUBRO_PRESUPUESTO=Q2RUB.K_RUBRO_PRESUPUESTO
										AND		Q2RUB.K_RUBRO_PADRE=Q1PAR.K_RUBRO_PRESUPUESTO
										AND		Q2PAR.K_PRESUPUESTO=Q1PAR.K_PRESUPUESTO		),
			W04_MONTO_EN_PROCESO = (	SELECT	SUM(Q2PAR.W04_MONTO_EN_PROCESO) AS SUM_MES_MONTO_EN_PROCESO 
										FROM	PARTIDA_PRESUPUESTO AS Q2PAR, RUBRO_PRESUPUESTO AS Q2RUB
										WHERE	Q2PAR.K_RUBRO_PRESUPUESTO=Q2RUB.K_RUBRO_PRESUPUESTO
										AND		Q2RUB.K_RUBRO_PADRE=Q1PAR.K_RUBRO_PRESUPUESTO
										AND		Q2PAR.K_PRESUPUESTO=Q1PAR.K_PRESUPUESTO		),
			W05_MONTO_EN_PROCESO = (	SELECT	SUM(Q2PAR.W05_MONTO_EN_PROCESO) AS SUM_MES_MONTO_EN_PROCESO 
										FROM	PARTIDA_PRESUPUESTO AS Q2PAR, RUBRO_PRESUPUESTO AS Q2RUB
										WHERE	Q2PAR.K_RUBRO_PRESUPUESTO=Q2RUB.K_RUBRO_PRESUPUESTO
										AND		Q2RUB.K_RUBRO_PADRE=Q1PAR.K_RUBRO_PRESUPUESTO
										AND		Q2PAR.K_PRESUPUESTO=Q1PAR.K_PRESUPUESTO		)
