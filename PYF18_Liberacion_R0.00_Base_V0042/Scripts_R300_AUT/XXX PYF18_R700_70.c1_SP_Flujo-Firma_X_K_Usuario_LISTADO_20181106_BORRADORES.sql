...
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[APG_LI_FLUJO_FIRMA_X_K_USUARIO_V1]') AND type in (N'P', N'PC'))
	DROP PROCEDURE [dbo].[APG_LI_FLUJO_FIRMA_X_K_USUARIO_V1]
GO	


CREATE PROCEDURE [dbo].[APG_LI_FLUJO_FIRMA_X_K_USUARIO_V1]
	@PP_L_DEBUG					INT,
...
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[APG_LI_FLUJO_FIRMA_X_K_USUARIO_V0_ORIGINAL]') AND type in (N'P', N'PC'))
	DROP PROCEDURE [dbo].[APG_LI_FLUJO_FIRMA_X_K_USUARIO_V0_ORIGINAL]
GO	


CREATE PROCEDURE [dbo].[APG_LI_FLUJO_FIRMA_X_K_USUARIO_V0_ORIGINAL]
	@PP_L_DEBUG					INT,
	@PP_K_SISTEMA_EXE			INT,
	@PP_K_USUARIO_ACCION		INT,
	-- ===========================
