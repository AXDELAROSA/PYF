...
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[CONTROL_X_MES]') AND type in (N'U'))
	DROP TABLE [dbo].[CONTROL_X_MES] 
GO
...
CREATE TABLE [dbo].[CONTROL_X_MES] (
	[K_YYYY]						[INT] NOT NULL,
	[K_MM]							[INT] NOT NULL,
	-- =====================================
...
ALTER TABLE [dbo].[CONTROL_X_MES]
	ADD CONSTRAINT [PK_CONTROL_X_MES]
		PRIMARY KEY CLUSTERED ( [K_YYYY], [K_MM] )
GO
...
ALTER TABLE [dbo].[CONTROL_X_MES] ADD 
	CONSTRAINT [FK_CONTROL_X_MES_01] 
...
ALTER TABLE [dbo].[CONTROL_X_MES] ADD 
	CONSTRAINT [FK_CONTROL_X_MES_USUARIO_ALTA]  
		FOREIGN KEY ([K_USUARIO_ALTA]) 
		REFERENCES [dbo].[USUARIO] ([K_USUARIO]),
	CONSTRAINT [FK_CONTROL_X_MES_USUARIO_CAMBIO]  
		FOREIGN KEY ([K_USUARIO_CAMBIO]) 
		REFERENCES [dbo].[USUARIO] ([K_USUARIO]),
	CONSTRAINT [FK_CONTROL_X_MES_USUARIO_BAJA]  
