...
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[CONTROL_X_MES_X_RAZON_SOCIAL]') AND type in (N'U'))
	DROP TABLE [dbo].[CONTROL_X_MES_X_RAZON_SOCIAL] 
GO



-- ///////////////////////////////////////////////////////////////
-- // CONTROL_X_MES_X_RAZON_SOCIAL 						
-- ///////////////////////////////////////////////////////////////


CREATE TABLE [dbo].[CONTROL_X_MES_X_RAZON_SOCIAL] (
	[K_YYYY]						[INT] NOT NULL,
	[K_MM]							[INT] NOT NULL,
...
ALTER TABLE [dbo].[CONTROL_X_MES_X_RAZON_SOCIAL]
	ADD CONSTRAINT [PK_CONTROL_X_MES_X_RAZON_SOCIAL]
		PRIMARY KEY CLUSTERED ( [K_YYYY], [K_MM], [K_RAZON_SOCIAL] )
GO
...
ALTER TABLE [dbo].[CONTROL_X_MES_X_RAZON_SOCIAL] ADD 
	CONSTRAINT [FK_CONTROL_X_MES_X_RAZON_SOCIAL_RS] 
...
ALTER TABLE [dbo].[CONTROL_X_MES_X_RAZON_SOCIAL] ADD 
	CONSTRAINT [FK_CONTROL_X_MES_X_RAZON_SOCIAL_01] 
...
ALTER TABLE [dbo].[CONTROL_X_MES_X_RAZON_SOCIAL] ADD 
	CONSTRAINT [FK_CONTROL_X_MES_X_RAZON_SOCIAL_USUARIO_ALTA]  
		FOREIGN KEY ([K_USUARIO_ALTA]) 
		REFERENCES [dbo].[USUARIO] ([K_USUARIO]),
	CONSTRAINT [FK_CONTROL_X_MES_X_RAZON_SOCIAL_USUARIO_CAMBIO]  
		FOREIGN KEY ([K_USUARIO_CAMBIO]) 
		REFERENCES [dbo].[USUARIO] ([K_USUARIO]),
	CONSTRAINT [FK_CONTROL_X_MES_X_RAZON_SOCIAL_USUARIO_BAJA]  
