...
-- ///////////////////////////////////////////////////////////////////
-- // STORED PROCEDURE ---> IN_MOVIMIENTO_FLUJO_DIARIO TÍTULO
-- ///////////////////////////////////////////////////////////////////
...
*/
	...
	DECLARE @VP_O_MIVIMIENTO_FLUJO_DIARIO			INT 

	IF @VP_K_MOVIMIENTO_FLUJO_DIARIO IS NULL -- SI K_MOVIMIENTO_FLUJO_DIARIO [TIPO TÍTULO] NO EXISTE, HACE EL INSERT
		BEGIN

		SET @VP_O_MIVIMIENTO_FLUJO_DIARIO = 0
		...
		EXECUTE [dbo].[PG_IN_MOVIMIENTO_FLUJO_DIARIO_SQL]	@PP_L_DEBUG, @PP_K_SISTEMA_EXE, @PP_K_USUARIO_ACCION,
															@VP_K_MOVIMIENTO_FLUJO_DIARIO, @VP_O_MIVIMIENTO_FLUJO_DIARIO, @PP_F_MOVIMIENTO_FLUJO_DIARIO, 
	...
	IF @VP_K_MOVIMIENTO_FLUJO_DIARIO IS NULL -- SI K_MOVIMIENTO_FLUJO_DIARIO [TIPO SALDO INICIAL, SALDO, FINAL O SUBTOTAL] NO EXISTE, HACE EL INSERT
		BEGIN

		SET @VP_O_MIVIMIENTO_FLUJO_DIARIO = 999999999
...
-- ///////////////////////////////////////////////////////////////////////
-- // STORED PROCEDURE --->  GENERAR MOVIMIENTO_FLUJO_DIARIO X K TRASPASO
-- ///////////////////////////////////////////////////////////////////////
...
AS
	...
	IF @VP_MENSAJE = ''
		EXECUTE [dbo].[PG_RN_MOVIMIENTO_FLUJO_DIARIO_X_K_TRASPASO]		@PP_L_DEBUG, @PP_K_SISTEMA_EXE, @PP_K_USUARIO_ACCION,
																		@PP_K_TRASPASO, @PP_K_UNIDAD_OPERATIVA, @PP_F_MOVIMIENTO_FLUJO_DIARIO,
	...
	IF @VP_MENSAJE<>''
		...
		SET		@VP_MENSAJE = 'No es posible <Crear> el Movimiento de Flujo Diario por Traspaso: ' + @VP_MENSAJE 
...
-- //////////////////////////////////////////////////////////////////////////
-- // STORED PROCEDURE --->  PROCESAR INSTRUCCIÓN X TRASPASO
-- //////////////////////////////////////////////////////////////////////////
...
AS
	...
	DECLARE @VP_MENSAJE		VARCHAR(1000)	= ''
	...
	IF @VP_MENSAJE=''
		EXECUTE [dbo].[PG_RN_INSTRUCCION_X_K_TRASPASO]		@PP_L_DEBUG, @PP_K_SISTEMA_EXE, @PP_K_USUARIO_ACCION,
															@PP_K_TRASPASO, @PP_F_INSTRUCCION,
															@OU_RESULTADO_VALIDACION = @VP_MENSAJE		OUTPUT
...
-- /////////////////////////////////////////////////////////////////////
	IF @PP_L_DEBUG > 0
		BEGIN
		PRINT '========================================================================='
		PRINT '> @PP_K_TRASPASO = '+CONVERT(VARCHAR(10),@PP_K_TRASPASO)
		PRINT '> @PP_F_INSTRUCCION = '+ CONVERT(VARCHAR(100),@PP_F_INSTRUCCION)
		PRINT '> @VP_K_INSTRUCCION = ' + CONVERT(VARCHAR(10),@VP_K_INSTRUCCION)
		PRINT '> @VP_K_UNIDAD_OPERATIVA = ' + CONVERT(VARCHAR(10),@VP_K_UNIDAD_OPERATIVA)
		PRINT '========================================================================='
		END
