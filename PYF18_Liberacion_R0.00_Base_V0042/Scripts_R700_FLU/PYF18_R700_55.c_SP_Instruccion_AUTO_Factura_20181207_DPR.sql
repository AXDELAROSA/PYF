...
-- //////////////////////////////////////////////////////////////////////////
-- // STORED PROCEDURE --->  GENERAR MOVIMIENTO_FLUJO_DIARIO X K FACTURA CXP
-- //////////////////////////////////////////////////////////////////////////
...
AS
	...
	IF @VP_MENSAJE = ''
		EXECUTE [dbo].[PG_RN_MOVIMIENTO_FLUJO_DIARIO_X_K_FACTURA_CXP]		@PP_L_DEBUG, @PP_K_SISTEMA_EXE, @PP_K_USUARIO_ACCION,
...
--		SET @VP_REFERENCIA_2 = @VP_REFERENCIA_2 + @VP_S_TIPO_COMPROBANTE + ' ' +'#'+ @VP_SERIE +'-' + @VP_FOLIO + ' '
	...
	IF @VP_MENSAJE<>''
		...
		SET		@VP_MENSAJE = 'No es posible <Crear> el Movimiento de Flujo Diario por Factura CXP: ' + @VP_MENSAJE 
...
-- //////////////////////////////////////////////////////////////////////////
-- // STORED PROCEDURE --->  PROCESAR INSTRUCCIÓN X FACTURA CXP
-- //////////////////////////////////////////////////////////////////////////
...
AS
	...
	IF @VP_MENSAJE=''
		EXECUTE [dbo].[PG_RN_INSTRUCCION_X_K_FACTURA_CXP]	@PP_L_DEBUG, @PP_K_SISTEMA_EXE, @PP_K_USUARIO_ACCION,
															@PP_K_FACTURA_CXP, @PP_F_INSTRUCCION,
															@OU_RESULTADO_VALIDACION = @VP_MENSAJE		OUTPUT
	...
	SELECT	@VP_MENSAJE AS MENSAJE, @PP_K_FACTURA_CXP AS CLAVE, @VP_K_INSTRUCCION AS INSTRUCCION, @VP_K_RESUMEN_FLUJO_DIARIO_X_UNO AS [RESUMEN FLUJO DIARIO X UNO]
